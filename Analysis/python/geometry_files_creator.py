...
def geomMaker(run_number):
	...
	runPath = os.path.abspath("geometry_files_creator.py").split('gemcrs')[0] + 'gemcrs/src/Validation/GEMCosmicMuonStand/test/'
	...
	geom_path = os.path.abspath("geometry_files_creator.py").split('gemcrs')[0] + 'gemcrs/src/Validation/GEMCosmicMuonStand/data/'
