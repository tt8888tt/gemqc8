...
def geomMaker(run_number, AlignOption):
	...
	configTablesPath = cmsswBase+'/src/gemqc8/Analysis/GEMQC8/data/StandConfigurationTables/'
	runPath = cmsswBase+'/src/gemqc8/Analysis/GEMQC8/test/'
	sys.path.insert(0,runPath)

	geom_path = cmsswBase+'/src/gemqc8/Analysis/GEMQC8/data/GeometryFiles/'
	alignmentTablesPath = cmsswBase+'/src/gemqc8/Analysis/GEMQC8/data/StandAligmentTables/'
